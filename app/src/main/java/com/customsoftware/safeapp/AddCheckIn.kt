...
class AddCheckIn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.customsoftware.safeapp.R.layout.add_check_in)
        txtnombrecheckin = findViewById<TextView>(com.customsoftware.safeapp.R.id.txtnombrecheckin)
        txtvehiculocheckin = findViewById<TextView>(com.customsoftware.safeapp.R.id.txtvehiculocheckin)
        txtplacacheckin = findViewById<TextView>(com.customsoftware.safeapp.R.id.txtplacacheckin)
        txtcredencialcheckin = findViewById<TextView>(com.customsoftware.safeapp.R.id.txtcredencialcheckin)
        txthoracheckin = findViewById<TextView>(com.customsoftware.safeapp.R.id.txthoracheckin)
        btninsertcheckin = findViewById<Button>(com.customsoftware.safeapp.R.id.btninsertcheckin)
        btnbackcheckin = findViewById<ImageButton>(com.customsoftware.safeapp.R.id.btnbackcheckin)
        ...
        btnbackcheckin.setOnClickListener {
            val Intent = Intent(this, com.customsoftware.safeapp.Check_in::class.java)
